...
struct Application {
    ...
    static void CancelQuit() {
        static Method<void> cancelquit = GetClass().GetMethod("CancelQuit");
        cancelquit();
    }
};
...
{
    static Class GetClass(){
        static Class cached = Class("UnityEngine", "SystemInfo", Image("UnityEngine.CoreModule.dll"));
        return cached;
    }
    static MonoType* GetType() {
        static MonoType* type = GetClass().GetMonoType();
    ...
    string GetDeviceUniqueIdentifier(){
        static Method<String*> getdeviceunique = GetClass().GetMethod("get_deviceUniqueIdentifier", 0);
        return getdeviceunique[this]()->str();
    }
    string GetOperatingSystem(){
        static Method<String*> operationgSystem = GetClass().GetMethod("get_operatingSystem", 0);
        return operationgSystem[this]()->str();
    }
    string GetDeviceModel(){
        static Method<String*> deviceModel = GetClass().GetMethod("get_deviceModel", 0);
        return deviceModel[this]()->str();
    }
    string GetProcessorType(){
        static Method<String*> GetProcessorType = GetClass().GetMethod("get_processorType", 0);
        return GetProcessorType[this]()->str();
    }
    string GetGraphicsDeviceName(){
        static Method<String*> getGraphicsDeviceName = GetClass().GetMethod("get_graphicsDeviceName", 0);
        return getGraphicsDeviceName[this]()->str();
    }
    float GetBatteryLevel() {
        static Method<float> getBatteryLevel = GetClass().GetMethod("get_batteryLevel", 0);
        return getBatteryLevel[this]();
    }
    int GetSystemMemorySize() {
        static Method<int> GetSystemMemorySize = GetClass().GetMethod("get_systemMemorySize", 0);
        return GetSystemMemorySize[this]();
    }
};