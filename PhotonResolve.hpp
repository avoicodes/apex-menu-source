...
struct Room : RoomInfo {
    ...
    void SetMaxPlayers(uint8_t players) {
        static Method<void> setMaxPlayers = GetClass().GetMethod("set_MaxPlayers", 1);
        setMaxPlayers[this](players);
    }
    bool GetIsOpen() {
        static Method<bool> getIsOpen = GetClass().GetMethod("get_IsOpen", 0);
        return getIsOpen[this]();
    ...
    void RemovePlayer(Player* player) {
        static Method<void> removePlayer = GetClass().GetMethod("RemovePlayer", 1);
    ...
    bool SetCustomProperties(Hashtable* propertiesToSet, Hashtable* expectedProperties = nullptr, Il2CppObject* webFlags = nullptr) {
        static Method<bool> SetCustomProperties = GetClass().GetMethod("SetCustomProperties", { "propertiesToSet", "expectedProperties", "webFlags" });
        return SetCustomProperties[this](propertiesToSet, expectedProperties, webFlags);
    }
...
struct Hashtable : unordered_map<Il2CppObject, Il2CppObject>{
    static Class GetClass(){
...
struct PhotonNetwork : IL2CPP::Il2CppObject {
    ...
    static void SendAllOutgoingCommands() {
        static Method<void> send = GetClass().GetMethod("SendAllOutgoingCommands");
        send();
    }
};
...
struct Recorder : Il2CppObject {
    static Class GetClass() {
        static Class dclass = Class("Photon.Voice.Unity", "Recorder");
        return dclass;
    }
    static MonoType* GetType() {
        static MonoType* type = GetClass().GetMonoType();
    ...
    int GetBitrate() {
        static Field<int> bit = GetClass().GetField("bitrate");
        bit.SetInstance(this);
        return bit();
    }
    void SetBitrate(int bitrate) {
        static Field<int> bitrae = GetClass().GetField("bitrate");
        bitrae.SetInstance(this);
        bitrae.Set(bitrate);
    }
};